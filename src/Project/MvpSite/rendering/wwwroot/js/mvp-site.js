                ...
                form.addEventListener('submit', function (event) {
                    ...
                    if (!form.checkValidity()) {
                        ...
                        $.ajax({
                            url: '/submitStep3',
                            type: 'post',
                            data: { firstName: _firstName, lastName: _lastName, preferredName: _preferredName, employmentStatus: _employmentStatus, companyName: _companyName, country: _country, state: '', mentor: _mentor },
                            dataType: 'json',
                            contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
                            success: function (data) {
                                if (data.success === true) {
